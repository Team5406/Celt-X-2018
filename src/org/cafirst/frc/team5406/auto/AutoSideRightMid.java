...
public class AutoSideRightMid  extends AutonomousRoutine{
	...
	public AutoSideRightMid(Drive _robotDrive, Intake _robotIntake){
		super("8 - Side Scale");
           ...
           if(gameData.length() > 0)
           {
    		...
    		drivePathDone = false;
			  ...
			  if(gameData.charAt(1) == 'R'){
				  ...
				  left.add(new Point2D.Double(-75, 210));
				  motionProfiler.bezierPoints(left, 0, -90, 9, 2);
